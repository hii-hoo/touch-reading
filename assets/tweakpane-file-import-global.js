;(() => {
  ...
  function deepMerge(r1, r2) {
    ...
    return keys.reduce((result, key) => {
      ...
      return isRecord(v1) && isRecord(v2)
        ? Object.assign(Object.assign({}, result), { [key]: deepMerge(v1, v2) })
      ...
      formatter:
        (_a = params.format) !== null && _a !== void 0
          ...
          : createNumberFormatter(
              getSuitableDecimalDigits(params, initialValue)
            ),
      keyScale:
  ...
  class TabPageApi extends ContainerBladeApi {
    get title() {
      var _a
      return (_a = this.controller.itemController.props.get("title")) !==
        null && _a !== void 0
        ? _a
        : ""
    }
  ...
  class TabView {
    constructor(doc, config) {
      ...
      bindValue(
        config.empty,
        valueToClassName(this.element, cn$k(undefined, "nop"))
      )
      const titleElem = doc.createElement("div")
  ...
  class PopupView {
    constructor(doc, config) {
      ...
      bindValue(
        config.shows,
        valueToClassName(this.element, cn$i(undefined, "v"))
      )
    }
  }
  ...
  class ColorView {
    constructor(doc, config) {
      ...
      config.foldable.bindExpandedClass(
        this.element,
        cn$c(undefined, "expanded")
      )
      bindValueMap(
        config.foldable,
        "completed",
        valueToClassName(this.element, cn$c(undefined, "cpl"))
      )
    ...
    getComponents(opt_mode) {
      return appendAlphaComponent(
        convertColor(
          ...
          {
            mode:
              opt_mode !== null && opt_mode !== void 0 ? opt_mode : this.mode,
            type: this.type,
          }
        ),
        this.comps_[3]
      ...
      if (drc) {
        return new SliderTextController(
          ...
          Object.assign(
            ...
            { parser: parseNumber, value: value, viewProps: args.viewProps }
          )
        )
      }
  ...
  class Point2dView {
    constructor(doc, config) {
      ...
      bindValue(
        config.expanded,
        valueToClassName(this.element, cn$4(undefined, "expanded"))
      )
      const headElem = doc.createElement("div")
  ...
  function computeOffset(ev, keyScales, invertsY) {
    return [
      ...
      getStepForKey(keyScales[1], getVerticalStepKeys(ev)) *
        (invertsY ? 1 : -1),
    ]
  }
    ...
    changeDraggingState(state) {
      ...
      if (state) {
        ;(_a = this.container) === null || _a === void 0
          ? void 0
          : _a.classList.add(containerClassName("input_area_dragging"))
      } else {
        ;(_b = this.container) === null || _b === void 0
          ? void 0
          : _b.classList.remove(containerClassName("input_area_dragging"))
      }
    }
  }
  ...
  class FilePluginController {
    ...
    isFileValid(file) {
      ...
      const fileExtension =
        "." +
        ((_a = file.name.split(".").pop()) === null || _a === void 0
          ? void 0
          : _a.toLowerCase())
      return !(
        filetypes &&
